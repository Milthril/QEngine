#ifndef CustomSlider_h__
#define CustomSlider_h__
...
public:
	...
	CustomSlider(QWidget* aParent = Q_NULLPTR);
	CustomSlider(Qt::Orientation ori, Options t = DoubleHandles, QWidget* aParent = Q_NULLPTR);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(CustomSlider::Options)

#endif // CustomSlider_h__
